...
public class ItemKaasSlab extends ItemBlock {
    ...
    public String getUnlocalizedName(ItemStack p_77667_1_) {
        return this.singleSlab.func_150002_b(p_77667_1_.getItemDamage());
    }
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_) {
        if (this.isDouble) {
            ...
            if ((p_77648_7_ == 1 && !flag || p_77648_7_ == 0 && flag) && block == this.singleSlab && j1 == p_77648_1_.getItemDamage()) {
                if (p_77648_3_.checkNoEntityCollision(this.doubleSlab.getCollisionBoundingBoxFromPool(p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_)) && p_77648_3_.setBlock(p_77648_4_, p_77648_5_, p_77648_6_, this.doubleSlab, j1, 3)) {
