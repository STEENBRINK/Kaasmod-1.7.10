...
public class Recipes
{
    public static void init()
    {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(KaasmodBlocks.smoothKaasSlab, 6), "CCC", 'C', new ItemStack(KaasmodBlocks.smoothKaasBlock)));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(KaasmodBlocks.smoothKaasStairs, 4), "C  ", "CC ", "CCC", 'C', new ItemStack(KaasmodBlocks.smoothKaasBlock)));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(KaasmodBlocks.kaasBricks, 4), "KK", "KK", 'K', new ItemStack(KaasmodBlocks.smoothKaasBlock)));
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(KaasmodBlocks.smoothKaasBlock, 4), "CC", "CC", 'C', new ItemStack(KaasmodItems.cheeseSlice)));
